...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    ...
    this.createVerifyCollectionOwnerRequest =
      this.createVerifyCollectionOwnerRequest.bind(this);
    this.submitVerifyCollectionOwner =
      this.submitVerifyCollectionOwner.bind(this);
  ...
  createMintRequest(
    ...
    const promise = this.rpc.request(
      "thesixnetwork.sixprotocol.nftoracle.Msg",
      "CreateMintRequest",
      data
    );
    return promise.then((data) =>
      MsgCreateMintRequestResponse.decode(new _m0.Reader(data))
    );
  }
  submitMintResponse(
    request: MsgSubmitMintResponse
    ...
    return promise.then((data) =>
      MsgSubmitMintResponseResponse.decode(new _m0.Reader(data))
    );
  }
  createActionRequest(
    request: MsgCreateActionRequest
    ...
    return promise.then((data) =>
      MsgCreateActionRequestResponse.decode(new _m0.Reader(data))
    );
  }
  submitActionResponse(
    request: MsgSubmitActionResponse
    ...
    return promise.then((data) =>
      MsgSubmitActionResponseResponse.decode(new _m0.Reader(data))
    );
  }
  createVerifyCollectionOwnerRequest(
    request: MsgCreateVerifyCollectionOwnerRequest
    ...
    return promise.then((data) =>
      MsgCreateVerifyCollectionOwnerRequestResponse.decode(new _m0.Reader(data))
    );
  }
  submitVerifyCollectionOwner(
    request: MsgSubmitVerifyCollectionOwner
    ...
    return promise.then((data) =>
      MsgSubmitVerifyCollectionOwnerResponse.decode(new _m0.Reader(data))
    );
  }
  setMinimumConfirmation(
    request: MsgSetMinimumConfirmation
    ...
    return promise.then((data) =>
      MsgSetMinimumConfirmationResponse.decode(new _m0.Reader(data))
    );
  }
  createActionSigner(
    request: MsgCreateActionSigner
    ...
    return promise.then((data) =>
      MsgCreateActionSignerResponse.decode(new _m0.Reader(data))
    );
  }
  updateActionSigner(
    request: MsgUpdateActionSigner
    ...
    return promise.then((data) =>
      MsgUpdateActionSignerResponse.decode(new _m0.Reader(data))
    );
  }
  deleteActionSigner(
    request: MsgDeleteActionSigner
    ...
    return promise.then((data) =>
      MsgDeleteActionSignerResponse.decode(new _m0.Reader(data))
    );
  }
  createActionSignerConfig(
    request: MsgCreateActionSignerConfig
    ...
    return promise.then((data) =>
      MsgCreateActionSignerConfigResponse.decode(new _m0.Reader(data))
    );
  }
  updateActionSignerConfig(
    request: MsgUpdateActionSignerConfig
    ...
    return promise.then((data) =>
      MsgUpdateActionSignerConfigResponse.decode(new _m0.Reader(data))
    );
  }
  deleteActionSignerConfig(
    request: MsgDeleteActionSignerConfig
    ...
    return promise.then((data) =>
      MsgDeleteActionSignerConfigResponse.decode(new _m0.Reader(data))
    );
  }
  createSyncActionSigner(
    request: MsgCreateSyncActionSigner
    ...
    return promise.then((data) =>
      MsgCreateSyncActionSignerResponse.decode(new _m0.Reader(data))
    );
  }
  submitSyncActionSigner(
    request: MsgSubmitSyncActionSigner
    ...
    return promise.then((data) =>
      MsgSubmitSyncActionSignerResponse.decode(new _m0.Reader(data))
    );
  }
}
