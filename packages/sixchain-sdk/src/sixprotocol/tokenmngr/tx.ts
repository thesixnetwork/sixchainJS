...
export const MsgMigrateDelegationResponse = {
  typeUrl: "/sixprotocol.tokenmngr.MsgMigrateDelegationResponse",
  encode(
    _: MsgMigrateDelegationResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial(
    _: Partial<MsgMigrateDelegationResponse>
  ): MsgMigrateDelegationResponse {
    const message = createBaseMsgMigrateDelegationResponse();
    return message;
  },
  fromAmino(
    _: MsgMigrateDelegationResponseAmino
  ): MsgMigrateDelegationResponse {
    const message = createBaseMsgMigrateDelegationResponse();
    return message;
  },
  ...
  fromAminoMsg(
    object: MsgMigrateDelegationResponseAminoMsg
  ): MsgMigrateDelegationResponse {
    return MsgMigrateDelegationResponse.fromAmino(object.value);
  },
  fromProtoMsg(
    message: MsgMigrateDelegationResponseProtoMsg
  ): MsgMigrateDelegationResponse {
  ...
  toProtoMsg(
    message: MsgMigrateDelegationResponse
  ): MsgMigrateDelegationResponseProtoMsg {
    return {
      typeUrl: "/sixprotocol.tokenmngr.MsgMigrateDelegationResponse",
