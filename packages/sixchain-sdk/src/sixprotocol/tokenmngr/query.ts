...
export const QueryListPrecompileRequest = {
  typeUrl: "/sixprotocol.tokenmngr.QueryListPrecompileRequest",
  encode(_: QueryListPrecompileRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryListPrecompileRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(_: Partial<QueryListPrecompileRequest>): QueryListPrecompileRequest {
    const message = createBaseQueryListPrecompileRequest();
    return message;
  },
  ...
  fromAminoMsg(object: QueryListPrecompileRequestAminoMsg): QueryListPrecompileRequest {
    return QueryListPrecompileRequest.fromAmino(object.value);
  },
  fromProtoMsg(message: QueryListPrecompileRequestProtoMsg): QueryListPrecompileRequest {
  ...
  toProtoMsg(message: QueryListPrecompileRequest): QueryListPrecompileRequestProtoMsg {
    return {
      typeUrl: "/sixprotocol.tokenmngr.QueryListPrecompileRequest",
...
export const QueryListPrecompileResponse = {
  typeUrl: "/sixprotocol.tokenmngr.QueryListPrecompileResponse",
  encode(message: QueryListPrecompileResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryListPrecompileResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryListPrecompileResponse>): QueryListPrecompileResponse {
    const message = createBaseQueryListPrecompileResponse();
    message.precompiles = object.precompiles?.map(e => e) || [];
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageResponse.fromPartial(object.pagination) : undefined;
    return message;
  },
  fromAmino(object: QueryListPrecompileResponseAmino): QueryListPrecompileResponse {
    const message = createBaseQueryListPrecompileResponse();
    message.precompiles = object.precompiles?.map(e => e) || [];
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromAmino(object.pagination);
  ...
  toAmino(message: QueryListPrecompileResponse): QueryListPrecompileResponseAmino {
    const obj: any = {};
  ...
  fromAminoMsg(object: QueryListPrecompileResponseAminoMsg): QueryListPrecompileResponse {
    return QueryListPrecompileResponse.fromAmino(object.value);
  },
  fromProtoMsg(message: QueryListPrecompileResponseProtoMsg): QueryListPrecompileResponse {
  ...
  toProtoMsg(message: QueryListPrecompileResponse): QueryListPrecompileResponseProtoMsg {
    return {
      typeUrl: "/sixprotocol.tokenmngr.QueryListPrecompileResponse",
