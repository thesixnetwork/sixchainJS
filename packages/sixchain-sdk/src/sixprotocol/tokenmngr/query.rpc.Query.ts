...
export interface Query {
  ...
  listPrecompile(request?: QueryListPrecompileRequest): Promise<QueryListPrecompileResponse>;
}
export class QueryClientImpl implements Query {
  ...
  listPrecompile(request: QueryListPrecompileRequest = {}): Promise<QueryListPrecompileResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.tokenmngr.Query", "ListPrecompile", data);
    return promise.then(data => QueryListPrecompileResponse.decode(new _m0.Reader(data)));
  }
}
