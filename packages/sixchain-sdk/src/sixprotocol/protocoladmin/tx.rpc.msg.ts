...
import { MsgUpdateParams, MsgUpdateParamsResponse, MsgCreateGroup, MsgCreateGroupResponse, MsgUpdateGroup, MsgUpdateGroupResponse, MsgDeleteGroup, MsgDeleteGroupResponse, MsgAddAdminToGroup, MsgAddAdminToGroupResponse, MsgRemoveAdminFromGroup, MsgRemoveAdminFromGroupResponse } from "./tx";
...
export class MsgClientImpl implements Msg {
  ...
  updateParams(request: MsgUpdateParams): Promise<MsgUpdateParamsResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.protocoladmin.Msg", "UpdateParams", data);
    return promise.then(data => MsgUpdateParamsResponse.decode(new _m0.Reader(data)));
  }
  createGroup(request: MsgCreateGroup): Promise<MsgCreateGroupResponse> {
    const data = MsgCreateGroup.encode(request).finish();
    const promise = this.rpc.request("sixprotocol.protocoladmin.Msg", "CreateGroup", data);
  ...
  updateGroup(request: MsgUpdateGroup): Promise<MsgUpdateGroupResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.protocoladmin.Msg", "UpdateGroup", data);
  ...
  deleteGroup(request: MsgDeleteGroup): Promise<MsgDeleteGroupResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.protocoladmin.Msg", "DeleteGroup", data);
  ...
  addAdminToGroup(request: MsgAddAdminToGroup): Promise<MsgAddAdminToGroupResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.protocoladmin.Msg", "AddAdminToGroup", data);
  ...
  removeAdminFromGroup(request: MsgRemoveAdminFromGroup): Promise<MsgRemoveAdminFromGroupResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.protocoladmin.Msg", "RemoveAdminFromGroup", data);
