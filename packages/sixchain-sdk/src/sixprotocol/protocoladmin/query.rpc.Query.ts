...
export class QueryClientImpl implements Query {
  ...
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "sixprotocol.protocoladmin.Query",
      "Params",
      data
    );
  ...
  admin(request: QueryGetAdminRequest): Promise<QueryGetAdminResponse> {
    ...
    return promise.then((data) =>
      QueryGetAdminResponse.decode(new _m0.Reader(data))
    );
  }
  adminAll(
    request: QueryAllAdminRequest = {
    ...
    return promise.then((data) =>
      QueryAllAdminResponse.decode(new _m0.Reader(data))
    );
  }
  group(request: QueryGetGroupRequest): Promise<QueryGetGroupResponse> {
    ...
    return promise.then((data) =>
      QueryGetGroupResponse.decode(new _m0.Reader(data))
    );
  }
  groupAll(
    ...
    return promise.then((data) =>
      QueryAllGroupResponse.decode(new _m0.Reader(data))
    );
  }
  listAdminOfGroup(
    request: QueryListAdminOfGroupRequest
    ...
    return promise.then((data) =>
      QueryListAdminOfGroupResponse.decode(new _m0.Reader(data))
    );
  }
}
