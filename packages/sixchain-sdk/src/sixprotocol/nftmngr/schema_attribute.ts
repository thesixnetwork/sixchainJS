...
export interface SchemaAttributeProtoMsg {
  typeUrl: "/sixprotocol.nftmngr.SchemaAttribute";
  value: Uint8Array;
}
/**
 * @name SchemaAttributeAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.SchemaAttribute
 */
...
export interface SchemaAttributeAminoMsg {
  type: "/sixprotocol.nftmngr.SchemaAttribute";
...
export interface SchemaAttributeValueProtoMsg {
  typeUrl: "/sixprotocol.nftmngr.SchemaAttributeValue";
  value: Uint8Array;
}
/**
 * @name SchemaAttributeValueAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.SchemaAttributeValue
 */
...
export interface SchemaAttributeValueAminoMsg {
  type: "/sixprotocol.nftmngr.SchemaAttributeValue";
...
export const SchemaAttribute = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.currentValue = SchemaAttributeValue.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromAmino(object: SchemaAttributeAmino): SchemaAttribute {
    ...
    if (object.current_value !== undefined && object.current_value !== null) {
      message.currentValue = SchemaAttributeValue.fromAmino(
  ...
  toAmino(message: SchemaAttribute): SchemaAttributeAmino {
    ...
    obj.current_value = message.currentValue
      ? SchemaAttributeValue.toAmino(message.currentValue)
      : undefined;
