 ...
 * @see proto type: sixprotocol.nftmngr.NFTSchema
 */
...
export interface NFTSchemaAminoMsg {
  type: "/sixprotocol.nftmngr.NFTSchema";
...
/**
 * @name NFTSchemaINPUTAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.NFTSchemaINPUT
 */
...
export interface NFTSchemaINPUTAminoMsg {
  type: "/sixprotocol.nftmngr.NFTSchemaINPUT";
...
/**
 * @name NFTSchemaQueryResultAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.NFTSchemaQueryResult
 */
...
export interface NFTSchemaQueryResultAminoMsg {
  type: "/sixprotocol.nftmngr.NFTSchemaQueryResult";
