...
export interface NFTFeeBalanceProtoMsg {
  typeUrl: "/sixprotocol.nftmngr.NFTFeeBalance";
  value: Uint8Array;
}
/**
 * @name NFTFeeBalanceAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.NFTFeeBalance
 */
...
export interface NFTFeeBalanceAminoMsg {
  type: "/sixprotocol.nftmngr.NFTFeeBalance";
