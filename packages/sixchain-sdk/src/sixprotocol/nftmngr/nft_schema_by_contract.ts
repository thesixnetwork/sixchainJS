...
export interface NFTSchemaByContractProtoMsg {
  typeUrl: "/sixprotocol.nftmngr.NFTSchemaByContract";
  value: Uint8Array;
}
/**
 * @name NFTSchemaByContractAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.NFTSchemaByContract
 */
...
export interface NFTSchemaByContractAminoMsg {
  type: "/sixprotocol.nftmngr.NFTSchemaByContract";
