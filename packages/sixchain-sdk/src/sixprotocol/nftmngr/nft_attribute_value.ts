...
/**
 * @name NftAttributeValueAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.NftAttributeValue
 */
...
export interface NftAttributeValueAminoMsg {
  type: "/sixprotocol.nftmngr.NftAttributeValue";
...
/**
 * @name NumberAttributeValueAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.NumberAttributeValue
 */
export interface NumberAttributeValueAmino {
  value?: string;
}
export interface NumberAttributeValueAminoMsg {
  type: "/sixprotocol.nftmngr.NumberAttributeValue";
...
/**
 * @name StringAttributeValueAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.StringAttributeValue
 */
export interface StringAttributeValueAmino {
  value?: string;
}
export interface StringAttributeValueAminoMsg {
  type: "/sixprotocol.nftmngr.StringAttributeValue";
...
/**
 * @name BooleanAttributeValueAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.BooleanAttributeValue
 */
export interface BooleanAttributeValueAmino {
  value?: boolean;
}
export interface BooleanAttributeValueAminoMsg {
  type: "/sixprotocol.nftmngr.BooleanAttributeValue";
...
/**
 * @name FloatAttributeValueAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.FloatAttributeValue
 */
export interface FloatAttributeValueAmino {
  value?: number;
}
export interface FloatAttributeValueAminoMsg {
  type: "/sixprotocol.nftmngr.FloatAttributeValue";
