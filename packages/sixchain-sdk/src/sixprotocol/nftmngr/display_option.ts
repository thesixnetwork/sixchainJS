...
export interface DisplayOptionProtoMsg {
  typeUrl: "/sixprotocol.nftmngr.DisplayOption";
  value: Uint8Array;
}
/**
 * @name DisplayOptionAmino
 * @package sixprotocol.nftmngr
 * @see proto type: sixprotocol.nftmngr.DisplayOption
 */
...
export interface DisplayOptionAminoMsg {
  type: "/sixprotocol.nftmngr.DisplayOption";
