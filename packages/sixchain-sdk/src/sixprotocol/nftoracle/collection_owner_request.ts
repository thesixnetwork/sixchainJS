...
/**
 * @name OriginContractParamAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.OriginContractParam
 */
...
export interface OriginContractParamAminoMsg {
  type: "/sixprotocol.nftoracle.OriginContractParam";
...
/**
 * @name CollectionOwnerRequestAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.CollectionOwnerRequest
 */
...
export interface CollectionOwnerRequestAminoMsg {
  type: "/sixprotocol.nftoracle.CollectionOwnerRequest";
...
/**
 * @name OriginContractInfoAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.OriginContractInfo
 */
...
export interface OriginContractInfoAminoMsg {
  type: "/sixprotocol.nftoracle.OriginContractInfo";
