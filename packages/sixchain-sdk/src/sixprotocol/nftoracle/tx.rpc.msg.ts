...
import { MsgUpdateParams, MsgUpdateParamsResponse, MsgCreateMintRequest, MsgCreateMintRequestResponse, MsgSubmitMintResponse, MsgSubmitMintResponseResponse, MsgCreateActionRequest, MsgCreateActionRequestResponse, MsgSubmitActionResponse, MsgSubmitActionResponseResponse, MsgCreateVerifyCollectionOwnerRequest, MsgCreateVerifyCollectionOwnerRequestResponse, MsgSubmitVerifyCollectionOwner, MsgSubmitVerifyCollectionOwnerResponse, MsgSetMinimumConfirmation, MsgSetMinimumConfirmationResponse, MsgCreateActionSigner, MsgCreateActionSignerResponse, MsgUpdateActionSigner, MsgUpdateActionSignerResponse, MsgDeleteActionSigner, MsgDeleteActionSignerResponse, MsgCreateActionSignerConfig, MsgCreateActionSignerConfigResponse, MsgUpdateActionSignerConfig, MsgUpdateActionSignerConfigResponse, MsgDeleteActionSignerConfig, MsgDeleteActionSignerConfigResponse, MsgCreateSyncActionSigner, MsgCreateSyncActionSignerResponse, MsgSubmitSyncActionSigner, MsgSubmitSyncActionSignerResponse } from "./tx";
...
export class MsgClientImpl implements Msg {
  ...
  updateParams(request: MsgUpdateParams): Promise<MsgUpdateParamsResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "UpdateParams", data);
    return promise.then(data => MsgUpdateParamsResponse.decode(new _m0.Reader(data)));
  }
  createMintRequest(request: MsgCreateMintRequest): Promise<MsgCreateMintRequestResponse> {
    const data = MsgCreateMintRequest.encode(request).finish();
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "CreateMintRequest", data);
  ...
  submitMintResponse(request: MsgSubmitMintResponse): Promise<MsgSubmitMintResponseResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "SubmitMintResponse", data);
  ...
  createActionRequest(request: MsgCreateActionRequest): Promise<MsgCreateActionRequestResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "CreateActionRequest", data);
  ...
  submitActionResponse(request: MsgSubmitActionResponse): Promise<MsgSubmitActionResponseResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "SubmitActionResponse", data);
  ...
  createVerifyCollectionOwnerRequest(request: MsgCreateVerifyCollectionOwnerRequest): Promise<MsgCreateVerifyCollectionOwnerRequestResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "CreateVerifyCollectionOwnerRequest", data);
  ...
  submitVerifyCollectionOwner(request: MsgSubmitVerifyCollectionOwner): Promise<MsgSubmitVerifyCollectionOwnerResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "SubmitVerifyCollectionOwner", data);
  ...
  setMinimumConfirmation(request: MsgSetMinimumConfirmation): Promise<MsgSetMinimumConfirmationResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "SetMinimumConfirmation", data);
  ...
  createActionSigner(request: MsgCreateActionSigner): Promise<MsgCreateActionSignerResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "CreateActionSigner", data);
  ...
  updateActionSigner(request: MsgUpdateActionSigner): Promise<MsgUpdateActionSignerResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "UpdateActionSigner", data);
  ...
  deleteActionSigner(request: MsgDeleteActionSigner): Promise<MsgDeleteActionSignerResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "DeleteActionSigner", data);
  ...
  createActionSignerConfig(request: MsgCreateActionSignerConfig): Promise<MsgCreateActionSignerConfigResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "CreateActionSignerConfig", data);
  ...
  updateActionSignerConfig(request: MsgUpdateActionSignerConfig): Promise<MsgUpdateActionSignerConfigResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "UpdateActionSignerConfig", data);
  ...
  deleteActionSignerConfig(request: MsgDeleteActionSignerConfig): Promise<MsgDeleteActionSignerConfigResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "DeleteActionSignerConfig", data);
  ...
  createSyncActionSigner(request: MsgCreateSyncActionSigner): Promise<MsgCreateSyncActionSignerResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "CreateSyncActionSigner", data);
  ...
  submitSyncActionSigner(request: MsgSubmitSyncActionSigner): Promise<MsgSubmitSyncActionSignerResponse> {
    ...
    const promise = this.rpc.request("sixprotocol.nftoracle.Msg", "SubmitSyncActionSigner", data);
