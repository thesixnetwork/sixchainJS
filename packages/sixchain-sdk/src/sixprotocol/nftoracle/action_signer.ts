...
export interface ActionSignerProtoMsg {
  typeUrl: "/sixprotocol.nftoracle.ActionSigner";
  value: Uint8Array;
}
/**
 * @name ActionSignerAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.ActionSigner
 */
...
export interface ActionSignerAminoMsg {
  type: "/sixprotocol.nftoracle.ActionSigner";
...
export interface SetSignerSignatureProtoMsg {
  typeUrl: "/sixprotocol.nftoracle.SetSignerSignature";
  value: Uint8Array;
}
/**
 * @name SetSignerSignatureAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.SetSignerSignature
 */
...
export interface SetSignerSignatureAminoMsg {
  type: "/sixprotocol.nftoracle.SetSignerSignature";
...
export interface SetSignerParamsProtoMsg {
  typeUrl: "/sixprotocol.nftoracle.SetSignerParams";
  value: Uint8Array;
}
/**
 * @name SetSignerParamsAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.SetSignerParams
 */
...
export interface SetSignerParamsAminoMsg {
  type: "/sixprotocol.nftoracle.SetSignerParams";
...
export const ActionSigner = {
  ...
  toAmino(message: ActionSigner): ActionSignerAmino {
    ...
    obj.creation_flow =
      message.creationFlow === 0 ? undefined : message.creationFlow;
    return obj;
  },
