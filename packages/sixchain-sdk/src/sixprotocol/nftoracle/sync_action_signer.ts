...
/**
 * @name SyncActionSignerAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.SyncActionSigner
 */
...
export interface SyncActionSignerAminoMsg {
  type: "/sixprotocol.nftoracle.SyncActionSigner";
...
/**
 * @name ParameterSyncSignerByOracleAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.ParameterSyncSignerByOracle
 */
...
export interface ParameterSyncSignerByOracleAminoMsg {
  type: "/sixprotocol.nftoracle.ParameterSyncSignerByOracle";
...
/**
 * @name ContractInfoHashAmino
 * @package sixprotocol.nftoracle
 * @see proto type: sixprotocol.nftoracle.ContractInfoHash
 */
...
export interface ContractInfoHashAminoMsg {
  type: "/sixprotocol.nftoracle.ContractInfoHash";
