...
export interface ParamsProtoMsg {
  typeUrl: "/sixprotocol.nftoracle.Params";
  value: Uint8Array;
}
/**
 * Params defines the parameters for the module.
 ...
 * @see proto type: sixprotocol.nftoracle.Params
 */
...
export interface ParamsAminoMsg {
  type: "sixprotocol/x/nftoracle/Params";
  value: ParamsAmino;
}
/** Params defines the parameters for the module. */
...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.verifyRequestActiveDuration = Duration.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.actionSignerActiveDuration = Duration.decode(
            reader,
            reader.uint32()
          );
          break;
        case 5:
          message.syncActionSignerActiveDuration = Duration.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromPartial(object: Partial<Params>): Params {
    ...
    message.actionRequestActiveDuration =
      ...
      object.actionRequestActiveDuration !== null
        ...
        : undefined;
    message.verifyRequestActiveDuration =
      object.verifyRequestActiveDuration !== undefined &&
      object.verifyRequestActiveDuration !== null
        ? Duration.fromPartial(object.verifyRequestActiveDuration)
        : undefined;
    message.actionSignerActiveDuration =
      object.actionSignerActiveDuration !== undefined &&
      object.actionSignerActiveDuration !== null
        ? Duration.fromPartial(object.actionSignerActiveDuration)
        : undefined;
    message.syncActionSignerActiveDuration =
      object.syncActionSignerActiveDuration !== undefined &&
      object.syncActionSignerActiveDuration !== null
  ...
  fromAmino(object: ParamsAmino): Params {
    ...
    if (
      ...
      message.mintRequestActiveDuration = Duration.fromAmino(
    ...
    if (
      ...
      message.actionRequestActiveDuration = Duration.fromAmino(
    ...
    if (
      ...
      message.verifyRequestActiveDuration = Duration.fromAmino(
    ...
    if (
      ...
      message.actionSignerActiveDuration = Duration.fromAmino(
    ...
    if (
      ...
      message.syncActionSignerActiveDuration = Duration.fromAmino(
  ...
  toAmino(message: Params): ParamsAmino {
    const obj: any = {};
    obj.mint_request_active_duration = message.mintRequestActiveDuration
      ? Duration.toAmino(message.mintRequestActiveDuration)
      : undefined;
    obj.action_request_active_duration = message.actionRequestActiveDuration
      ? Duration.toAmino(message.actionRequestActiveDuration)
      : undefined;
    obj.verify_request_active_duration = message.verifyRequestActiveDuration
      ? Duration.toAmino(message.verifyRequestActiveDuration)
      : undefined;
    obj.action_signer_active_duration = message.actionSignerActiveDuration
      ? Duration.toAmino(message.actionSignerActiveDuration)
      : undefined;
    obj.sync_action_signer_active_duration =
      message.syncActionSignerActiveDuration
        ? Duration.toAmino(message.syncActionSignerActiveDuration)
        : undefined;
    return obj;
  },
