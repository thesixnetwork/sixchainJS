...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/sixprotocol.nftadmin.MsgUpdateParams", MsgUpdateParams], ["/sixprotocol.nftadmin.MsgGrantPermission", MsgGrantPermission], ["/sixprotocol.nftadmin.MsgRevokePermission", MsgRevokePermission]];
