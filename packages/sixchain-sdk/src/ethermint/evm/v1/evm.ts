 ...
 * @package ethermint.evm.v1
 * @see proto type: ethermint.evm.v1.AccessControl
 */
 ...
 * @package ethermint.evm.v1
 * @see proto type: ethermint.evm.v1.AccessControlType
 */
...
export const AccessControlType = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AccessControlType {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: ChainConfig): ChainConfigAmino {
    ...
    obj.merge_netsplit_block =
      message.mergeNetsplitBlock === ""
        ...
        : message.mergeNetsplitBlock;
    obj.shanghai_time =
      message.shanghaiTime === "" ? undefined : message.shanghaiTime;
    obj.cancun_time =
      message.cancunTime === "" ? undefined : message.cancunTime;
    obj.prague_time =
      message.pragueTime === "" ? undefined : message.pragueTime;
    obj.verkle_time =
      message.verkleTime === "" ? undefined : message.verkleTime;
    return obj;
  },
...
export const TraceConfig = {
  ...
  toAmino(message: TraceConfig): TraceConfigAmino {
    ...
    obj.reexec = !message.reexec.isZero()
      ? message.reexec?.toString()
      : undefined;
