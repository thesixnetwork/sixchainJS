...
export interface Token {
  $typeUrl?: "/thesixnetwork.sixprotocol.tokenmngr.v2.Token";
  name: string;
  base: string;
  maxSupply: Coin;
  mintee: string;
...
export interface TokenAminoMsg {
  type: "/thesixnetwork.sixprotocol.tokenmngr.v2.Token";
  value: TokenAmino;
}
/** @deprecated */
...
export interface DenomUnitProtoMsg {
  typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.v2.DenomUnit";
  value: Uint8Array;
}
/**
 * DenomUnit represents a struct that describes a given
...
export interface DenomUnitAminoMsg {
  type: "/thesixnetwork.sixprotocol.tokenmngr.v2.DenomUnit";
...
export interface MetadataProtoMsg {
  typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.v2.Metadata";
  value: Uint8Array;
}
/**
 * Metadata represents a struct that describes
...
export interface MetadataAminoMsg {
  type: "/thesixnetwork.sixprotocol.tokenmngr.v2.Metadata";
  value: MetadataAmino;
}
/**
 * Metadata represents a struct that describes
