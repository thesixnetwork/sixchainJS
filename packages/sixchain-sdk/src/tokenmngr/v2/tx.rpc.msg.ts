...
export class MsgClientImpl implements Msg {
  ...
  createToken(request: MsgCreateToken): Promise<MsgCreateTokenResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "CreateToken", data);
  ...
  updateToken(request: MsgUpdateToken): Promise<MsgUpdateTokenResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "UpdateToken", data);
  ...
  deleteToken(request: MsgDeleteToken): Promise<MsgDeleteTokenResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "DeleteToken", data);
  ...
  createMintperm(request: MsgCreateMintperm): Promise<MsgCreateMintpermResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "CreateMintperm", data);
  ...
  updateMintperm(request: MsgUpdateMintperm): Promise<MsgUpdateMintpermResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "UpdateMintperm", data);
  ...
  deleteMintperm(request: MsgDeleteMintperm): Promise<MsgDeleteMintpermResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "DeleteMintperm", data);
    return promise.then(data => MsgDeleteMintpermResponse.decode(new _m0.Reader(data)));
  }
  mint(request: MsgMint): Promise<MsgMintResponse> {
    const data = MsgMint.encode(request).finish();
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "Mint", data);
    return promise.then(data => MsgMintResponse.decode(new _m0.Reader(data)));
  }
  createOptions(request: MsgCreateOptions): Promise<MsgCreateOptionsResponse> {
    const data = MsgCreateOptions.encode(request).finish();
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "CreateOptions", data);
  ...
  updateOptions(request: MsgUpdateOptions): Promise<MsgUpdateOptionsResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "UpdateOptions", data);
  ...
  deleteOptions(request: MsgDeleteOptions): Promise<MsgDeleteOptionsResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "DeleteOptions", data);
    return promise.then(data => MsgDeleteOptionsResponse.decode(new _m0.Reader(data)));
  }
  burn(request: MsgBurn): Promise<MsgBurnResponse> {
    const data = MsgBurn.encode(request).finish();
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "Burn", data);
    return promise.then(data => MsgBurnResponse.decode(new _m0.Reader(data)));
  }
  wrapToken(request: MsgWrapToken): Promise<MsgWrapTokenResponse> {
    const data = MsgWrapToken.encode(request).finish();
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "WrapToken", data);
    return promise.then(data => MsgWrapTokenResponse.decode(new _m0.Reader(data)));
  }
  unwrapToken(request: MsgUnwrapToken): Promise<MsgUnwrapTokenResponse> {
    const data = MsgUnwrapToken.encode(request).finish();
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "UnwrapToken", data);
  ...
  sendWrapToken(request: MsgSendWrapToken): Promise<MsgSendWrapTokenResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Msg", "SendWrapToken", data);
