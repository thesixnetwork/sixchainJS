...
export class QueryClientImpl implements Query {
  ...
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new _m0.Reader(data)));
  }
  token(request: QueryGetTokenRequest): Promise<QueryGetTokenResponse> {
    const data = QueryGetTokenRequest.encode(request).finish();
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "Token", data);
  ...
  tokenAll(request: QueryAllTokenRequest = {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "TokenAll", data);
  ...
  mintperm(request: QueryGetMintpermRequest): Promise<QueryGetMintpermResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "Mintperm", data);
  ...
  mintpermAll(request: QueryAllMintpermRequest = {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "MintpermAll", data);
  ...
  options(request: QueryGetOptionsRequest = {}): Promise<QueryGetOptionsResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "Options", data);
  ...
  burns(request: QueryBurnsRequest = {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "Burns", data);
  ...
  tokenBurn(request: QueryGetTokenBurnRequest): Promise<QueryGetTokenBurnResponse> {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "TokenBurn", data);
  ...
  tokenBurnAll(request: QueryAllTokenBurnRequest = {
    ...
    const promise = this.rpc.request("thesixnetwork.sixprotocol.tokenmngr.v2.Query", "TokenBurnAll", data);
