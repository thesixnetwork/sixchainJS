...
export interface MsgMintVersionTwoProtoMsg {
  typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.MsgMintVersionTwo";
  value: Uint8Array;
}
export interface MsgMintVersionTwoAmino {
  creator?: string;
  amount?: CoinAmino;
}
export interface MsgMintVersionTwoAminoMsg {
  type: "/thesixnetwork.sixprotocol.tokenmngr.MsgMintVersionTwo";
  value: MsgMintVersionTwoAmino;
}
export interface MsgMintVersionTwoSDKType {
  creator: string;
  amount: CoinSDKType;
}
...
function createBaseMsgMintVersionTwo(): MsgMintVersionTwo {
  return {
    creator: "",
...
export const MsgMintVersionTwo = {
  typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.MsgMintVersionTwo",
  encode(message: MsgMintVersionTwo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgMintVersionTwo {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgMintVersionTwo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: Partial<MsgMintVersionTwo>): MsgMintVersionTwo {
    const message = createBaseMsgMintVersionTwo();
    message.creator = object.creator ?? "";
    message.amount = object.amount !== undefined && object.amount !== null ? Coin.fromPartial(object.amount) : undefined;
    return message;
  },
  fromAmino(object: MsgMintVersionTwoAmino): MsgMintVersionTwo {
    const message = createBaseMsgMintVersionTwo();
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = object.creator;
    }
  ...
  toAmino(message: MsgMintVersionTwo): MsgMintVersionTwoAmino {
    const obj: any = {};
    obj.creator = message.creator === "" ? undefined : message.creator;
    obj.amount = message.amount ? Coin.toAmino(message.amount) : undefined;
    return obj;
  },
  fromAminoMsg(object: MsgMintVersionTwoAminoMsg): MsgMintVersionTwo {
    return MsgMintVersionTwo.fromAmino(object.value);
  },
  fromProtoMsg(message: MsgMintVersionTwoProtoMsg): MsgMintVersionTwo {
    return MsgMintVersionTwo.decode(message.value);
  },
  toProto(message: MsgMintVersionTwo): Uint8Array {
    return MsgMintVersionTwo.encode(message).finish();
  },
  toProtoMsg(message: MsgMintVersionTwo): MsgMintVersionTwoProtoMsg {
    return {
      typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.MsgMintVersionTwo",
      value: MsgMintVersionTwo.encode(message).finish()
    };
  }
};
