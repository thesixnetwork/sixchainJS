...
export const UninterpretedOption = {
  ...
  fromAmino(object: UninterpretedOptionAmino): UninterpretedOption {
    ...
    if (object.positive_int_value !== undefined && object.positive_int_value !== null) {
      message.positiveIntValue = Long.fromString(object.positive_int_value);
    }
    if (object.negative_int_value !== undefined && object.negative_int_value !== null) {
      message.negativeIntValue = Long.fromString(object.negative_int_value);
    }
  ...
  toAmino(message: UninterpretedOption): UninterpretedOptionAmino {
    ...
    obj.positive_int_value = !message.positiveIntValue.isZero() ? message.positiveIntValue?.toString() : undefined;
    obj.negative_int_value = !message.negativeIntValue.isZero() ? message.negativeIntValue?.toString() : undefined;
