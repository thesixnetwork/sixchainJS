...
export const QueryVerifyMembershipRequest = {
  ...
  toAmino(message: QueryVerifyMembershipRequest): QueryVerifyMembershipRequestAmino {
    ...
    obj.time_delay = !message.timeDelay.isZero() ? message.timeDelay?.toString() : undefined;
    obj.block_delay = !message.blockDelay.isZero() ? message.blockDelay?.toString() : undefined;
    return obj;
  },
