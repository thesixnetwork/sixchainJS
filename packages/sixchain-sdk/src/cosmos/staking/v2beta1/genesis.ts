...
export interface GenesisStateProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.GenesisState";
  value: Uint8Array;
}
/** GenesisState defines the staking module's genesis state. */
...
export interface LastValidatorPowerProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.LastValidatorPower";
  value: Uint8Array;
}
/** LastValidatorPower required for validator set update logic. */
...
export const GenesisState = {
  ...
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.validatorApproval !== undefined) {
      ValidatorApproval.encode(message.validatorApproval, writer.uint32(34).fork()).ldelim();
    }
    ...
    for (const v of message.unbondingDelegations) {
      UnbondingDelegation.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    for (const v of message.redelegations) {
      Redelegation.encode(v!, writer.uint32(66).fork()).ldelim();
    }
