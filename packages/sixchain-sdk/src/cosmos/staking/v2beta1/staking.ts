...
export interface HistoricalInfoProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.HistoricalInfo";
  value: Uint8Array;
}
/**
 * HistoricalInfo contains header and validator information for a given block.
...
export interface CommissionRatesProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.CommissionRates";
  value: Uint8Array;
}
/**
 * CommissionRates defines the initial commission rates to be used for creating
...
export interface CommissionProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.Commission";
  value: Uint8Array;
}
/** Commission defines commission parameters for a given validator. */
...
export interface DescriptionProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.Description";
  value: Uint8Array;
}
/** Description defines a validator description. */
...
export interface ValidatorProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.Validator";
  value: Uint8Array;
}
...
export interface ValAddressesProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.ValAddresses";
  value: Uint8Array;
}
/** ValAddresses defines a repeated set of validator addresses. */
...
export interface DVPairProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.DVPair";
  value: Uint8Array;
}
/**
 * DVPair is struct that just has a delegator-validator pair with no other data.
...
export interface DVPairsProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.DVPairs";
  value: Uint8Array;
}
/** DVPairs defines an array of DVPair objects. */
...
export interface DVVTripletProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.DVVTriplet";
  value: Uint8Array;
}
/**
 * DVVTriplet is struct that just has a delegator-validator-validator triplet
...
export interface DVVTripletsProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.DVVTriplets";
  value: Uint8Array;
}
/** DVVTriplets defines an array of DVVTriplet objects. */
...
export interface DelegationProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.Delegation";
  value: Uint8Array;
}
/**
 * Delegation represents the bond with tokens held by an account. It is
...
export interface UnbondingDelegationProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.UnbondingDelegation";
  value: Uint8Array;
}
/**
 * UnbondingDelegation stores all of a single delegator's unbonding bonds
...
export interface UnbondingDelegationEntryProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.UnbondingDelegationEntry";
  value: Uint8Array;
}
/** UnbondingDelegationEntry defines an unbonding object with relevant metadata. */
...
export interface RedelegationEntryProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.RedelegationEntry";
  value: Uint8Array;
}
/** RedelegationEntry defines a redelegation object with relevant metadata. */
...
export interface RedelegationProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.Redelegation";
  value: Uint8Array;
}
/**
 * Redelegation contains the list of a particular delegator's redelegating bonds
...
export interface ParamsProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.Params";
  value: Uint8Array;
}
/** Params defines the parameters for the staking module. */
...
export interface DelegationResponseProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.DelegationResponse";
  value: Uint8Array;
}
/**
 * DelegationResponse is equivalent to Delegation except that it contains a
...
export interface RedelegationEntryResponseProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.RedelegationEntryResponse";
  value: Uint8Array;
}
/**
 * RedelegationEntryResponse is equivalent to a RedelegationEntry except that it
...
export interface RedelegationResponseProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.RedelegationResponse";
  value: Uint8Array;
}
/**
 * RedelegationResponse is equivalent to a Redelegation except that its entries
...
export interface PoolProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.Pool";
  value: Uint8Array;
}
/**
 * Pool is used for tracking bonded and not-bonded token supply of the bond
...
export interface ValidatorApprovalProtoMsg {
  typeUrl: "/cosmos.staking.v2beta1.ValidatorApproval";
  value: Uint8Array;
}
...
export const ValidatorApproval = {
  typeUrl: "/cosmos.staking.v2beta1.ValidatorApproval",
  encode(message: ValidatorApproval, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
