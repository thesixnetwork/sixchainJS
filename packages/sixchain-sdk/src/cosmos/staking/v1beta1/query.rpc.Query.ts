...
export class QueryClientImpl implements Query {
  ...
  validatorApproval(
    ...
    return promise.then((data) =>
      QueryValidatorApprovalResponse.decode(new _m0.Reader(data))
    );
  }
  validators(
  ...
  whitelistdelegator(
    ...
    return promise.then((data) =>
      QueryWhitelistdelegatorResponse.decode(new _m0.Reader(data))
    );
  }
  whitelistdelegatorAll(
    request: QueryAllWhitelistDelegatorRequest = {
    ...
    return promise.then((data) =>
      QueryWhitelistdelegatorAllResponse.decode(new _m0.Reader(data))
    );
  }
}
