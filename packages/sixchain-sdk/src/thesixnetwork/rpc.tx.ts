...
export const createRPCMsgClient = async ({ rpc }: { rpc: Rpc }) => ({
  ...
  thesixnetwork: {
    sixprotocol: {
      ...
      nftoracle: new (await import("../nftoracle/tx.rpc.msg")).MsgClientImpl(
        rpc
      ),
      protocoladmin: new (
        await import("../protocoladmin/tx.rpc.msg")
      ).MsgClientImpl(rpc),
      tokenmngr: new (await import("../tokenmngr/tx.rpc.msg")).MsgClientImpl(
        rpc
      ),
    },
  },
