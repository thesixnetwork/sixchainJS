...
import * as nftmngrLatestTxRegistry from "../nftmngr/latest/tx.registry";
...
import * as nftmngrLatestTxAmino from "../nftmngr/latest/tx.amino";
...
export const thesixnetworkAminoConverters = {
  ...
  ...nftmngrLatestTxAmino.AminoConverter,
...
export const thesixnetworkProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...nftadminTxRegistry.registry, ...nftmngrLatestTxRegistry.registry, ...nftoracleTxRegistry.registry, ...protocoladminTxRegistry.registry, ...tokenmngrV1TxRegistry.registry, ...tokenmngrV2TxRegistry.registry];
