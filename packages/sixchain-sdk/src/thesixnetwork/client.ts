...
export const thesixnetworkProtoRegistry: ReadonlyArray<
  [string, GeneratedType]
> = [
  ...nftadminTxRegistry.registry,
  ...nftmngrTxRegistry.registry,
  ...nftoracleTxRegistry.registry,
  ...protocoladminTxRegistry.registry,
  ...tokenmngrTxRegistry.registry,
];
...
export const getSigningThesixnetworkClient = async ({
  ...
  const { registry, aminoTypes } = getSigningThesixnetworkClientOptions({
    defaultTypes,
  });
