...
export * as ITxNFTmngr from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftmngr/module/types/nftmngr/tx';
// legacy code will be replicated and replaced with typesTxNFTAdmin
export * as ITxNFTadmin from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftadmin/module/types/nftadmin/tx';
...
// ############### SIX PROTOCOL ###############
// ################### TX ##################
export * as typesTxProtocolAdmin from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.protocoladmin/module/types/protocoladmin/tx';
export * as typesTxTokenManager from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.tokenmngr/module/types/tokenmngr/tx';

// ################### Query ##################
export * as typesQueryProtocolAdmin from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.protocoladmin/module/types/protocoladmin/query';
export * as typesQueryTokenManager from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.tokenmngr/module/types/tokenmngr/query';


// ############### SIXNFT ###############
// ################### TX ##################
// legacy code will be replicated and replaced with typesTxNFTOracle
export * as typesTxNFTAdmin from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftadmin/module/types/nftadmin/tx';
export * as typesTxNFTManager from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftmngr/module/types/nftmngr/tx';
export * as ITxNFToracle from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftoracle/module/types/nftoracle/tx';
export * as typesTxNFTOracle from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftoracle/module/types/nftoracle/tx';

// ################### Query ##################
export * as typesQueryNFTAdmin from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftadmin/module/types/nftadmin/query';
export * as typesQueryNFTManager from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftmngr/module/types/nftmngr/query';
export * as typesQueryNFTOracle from './modules/thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftoracle/module/types/nftoracle/query';
