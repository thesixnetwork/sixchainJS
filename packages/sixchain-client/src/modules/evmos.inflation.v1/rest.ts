...
import { QueryPeriodResponse } from "./types/evmos/inflation/v1/query";
import { QueryEpochMintProvisionResponse } from "./types/evmos/inflation/v1/query";
import { QuerySkippedEpochsResponse } from "./types/evmos/inflation/v1/query";
import { QueryCirculatingSupplyResponse } from "./types/evmos/inflation/v1/query";
import { QueryInflationRateResponse } from "./types/evmos/inflation/v1/query";
import { QueryParamsResponse } from "./types/evmos/inflation/v1/query";

import { QueryPeriodRequest } from "./types/evmos/inflation/v1/query";
import { QueryEpochMintProvisionRequest } from "./types/evmos/inflation/v1/query";
import { QuerySkippedEpochsRequest } from "./types/evmos/inflation/v1/query";
import { QueryCirculatingSupplyRequest } from "./types/evmos/inflation/v1/query";
import { QueryInflationRateRequest } from "./types/evmos/inflation/v1/query";
import { QueryParamsRequest } from "./types/evmos/inflation/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryPeriod = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryPeriodResponse>>>({
  ...
  /**
   * QueryEpochMintProvision
   *
   * @tags Query
   * @name queryEpochMintProvision
  ...
  queryEpochMintProvision = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryEpochMintProvisionResponse>>>({
  ...
  querySkippedEpochs = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QuerySkippedEpochsResponse>>>({
  ...
  queryCirculatingSupply = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryCirculatingSupplyResponse>>>({
  ...
  queryInflationRate = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryInflationRateResponse>>>({
