...
const baseQueryConsensusStateHeightsRequest: object = { client_id: "" };
...
export const QueryConsensusStateHeightsResponse = {
  ...
  fromJSON(object: any): QueryConsensusStateHeightsResponse {
    ...
    message.consensus_state_heights = [];
    if (
      object.consensus_state_heights !== undefined &&
      object.consensus_state_heights !== null
    ) {
      for (const e of object.consensus_state_heights) {
        message.consensus_state_heights.push(Height.fromJSON(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromJSON(object.pagination);
  ...
  fromPartial(
    ...
    if (
      ...
      for (const e of object.consensus_state_heights) {
        message.consensus_state_heights.push(Height.fromPartial(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromPartial(object.pagination);
