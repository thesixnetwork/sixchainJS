...
function createBaseOpenseaDisplayOption(): OpenseaDisplayOption {
  return { displayType: "", traitType: "", maxValue: 0 };
}

export const OpenseaDisplayOption: MessageFns<OpenseaDisplayOption> = {
  encode(message: OpenseaDisplayOption, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.maxValue = longToNumber(reader.uint64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  create<I extends Exact<DeepPartial<OpenseaDisplayOption>, I>>(base?: I): OpenseaDisplayOption {
    return OpenseaDisplayOption.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenseaDisplayOption>, I>>(object: I): OpenseaDisplayOption {
    const message = createBaseOpenseaDisplayOption();
