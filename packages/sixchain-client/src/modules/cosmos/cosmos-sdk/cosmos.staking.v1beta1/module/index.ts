...
const txClient = async (
  ...
  return {
    ...
    msgSetValidatorApproval: (data: MsgSetValidatorApproval): EncodeObject => ({
      typeUrl: "/cosmos.staking.v1beta1.MsgSetValidatorApproval",
      value: MsgSetValidatorApproval.fromPartial(data),
    }),
    msgDeleteWhitelistDelegator: (
      data: MsgDeleteWhitelistDelegator
    ): EncodeObject => ({
      typeUrl: "/cosmos.staking.v1beta1.MsgDeleteWhitelistDelegator",
      value: MsgDeleteWhitelistDelegator.fromPartial(data),
    }),
    ...
    msgCreateWhitelistDelegator: (
      data: MsgCreateWhitelistDelegator
    ): EncodeObject => ({
      typeUrl: "/cosmos.staking.v1beta1.MsgCreateWhitelistDelegator",
      value: MsgCreateWhitelistDelegator.fromPartial(data),
    }),
