...
export const Validator = {
  encode(message: Validator, writer: Writer = Writer.create()): Writer {
    ...
    if (message.min_delegation !== "") {
      writer.uint32(98).string(message.min_delegation);
    }
    if (message.delegation_increment !== "") {
      writer.uint32(106).string(message.delegation_increment);
    }
    if (message.max_license !== "") {
      writer.uint32(114).string(message.max_license);
    }
    if (message.license_count !== "") {
      writer.uint32(122).string(message.license_count);
    }
    if (message.license_mode === true) {
      writer.uint32(128).bool(message.license_mode);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14:
          ...
          break;
        case 15:
          message.license_count = reader.string();
          break;
        case 16:
  ...
  fromJSON(object: any): Validator {
    ...
    if (object.license_count !== undefined && object.license_count !== null) {
      message.license_count = String(object.license_count);
    } else {
      message.license_count = "";
    }
  ...
  toJSON(message: Validator): unknown {
    ...
    message.license_count !== undefined &&
      (obj.license_count = message.license_count);
  ...
  fromPartial(object: DeepPartial<Validator>): Validator {
    ...
    if (object.license_count !== undefined && object.license_count !== null) {
      message.license_count = object.license_count;
    } else {
      message.license_count = "";
    }
    if (object.license_mode !== undefined && object.license_mode !== null) {
...
const baseValidatorApproval: object = { approver_address: "", enabled: false };

export const ValidatorApproval = {
  encode(message: ValidatorApproval, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): ValidatorApproval {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseValidatorApproval } as ValidatorApproval;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ValidatorApproval {
    const message = { ...baseValidatorApproval } as ValidatorApproval;
    if (
  ...
  toJSON(message: ValidatorApproval): unknown {
    const obj: any = {};
  ...
  fromPartial(object: DeepPartial<ValidatorApproval>): ValidatorApproval {
    const message = { ...baseValidatorApproval } as ValidatorApproval;
    if (
      object.approver_address !== undefined &&
      object.approver_address !== null
