...
export const QueryValidatorApprovalRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseQueryValidatorApprovalRequest,
    } as QueryValidatorApprovalRequest;
  ...
  fromJSON(_: any): QueryValidatorApprovalRequest {
    const message = {
      ...baseQueryValidatorApprovalRequest,
    } as QueryValidatorApprovalRequest;
    return message;
  ...
  toJSON(_: QueryValidatorApprovalRequest): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial(
    _: DeepPartial<QueryValidatorApprovalRequest>
  ): QueryValidatorApprovalRequest {
    const message = {
      ...baseQueryValidatorApprovalRequest,
    } as QueryValidatorApprovalRequest;
...
const baseQueryValidatorApprovalResponse: object = {};
...
export const QueryValidatorApprovalResponse = {
  encode(
    ...
    if (message.validator_approval !== undefined) {
      ValidatorApproval.encode(
        message.validator_approval,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryValidatorApprovalResponse,
    } as QueryValidatorApprovalResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.validator_approval = ValidatorApproval.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): QueryValidatorApprovalResponse {
    const message = {
      ...baseQueryValidatorApprovalResponse,
    } as QueryValidatorApprovalResponse;
    if (
      ...
      message.validator_approval = ValidatorApproval.fromJSON(
        object.validator_approval
      );
    } else {
      message.validator_approval = undefined;
    }
    return message;
  },

  toJSON(message: QueryValidatorApprovalResponse): unknown {
    const obj: any = {};
    message.validator_approval !== undefined &&
      (obj.validator_approval = message.validator_approval
        ? ValidatorApproval.toJSON(message.validator_approval)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryValidatorApprovalResponse>
  ): QueryValidatorApprovalResponse {
    const message = {
      ...baseQueryValidatorApprovalResponse,
    } as QueryValidatorApprovalResponse;
    if (
      ...
      message.validator_approval = ValidatorApproval.fromPartial(
        object.validator_approval
      );
    } else {
      message.validator_approval = undefined;
...
export interface Query {
  ...
  ValidatorApproval(
    request: QueryValidatorApprovalRequest
  ): Promise<QueryValidatorApprovalResponse>;
  /** Validators queries all validators that match the given status. */
...
export class QueryClientImpl implements Query {
  ...
  ValidatorApproval(
    ...
    return promise.then((data) =>
      QueryValidatorApprovalResponse.decode(new Reader(data))
    );
  }
