...
export interface NftoracleQueryAllActionRequestResponse {
  ActionOracleRequest?: SixprotocolnftoracleActionOracleRequest[];
...
export interface NftoracleQueryAllActionSignerConfigResponse {
  actionSignerConfig?: SixprotocolnftoracleActionSignerConfig[];
...
export interface NftoracleQueryAllActionSignerResponse {
  actionSigner?: SixprotocolnftoracleActionSigner[];
...
export interface NftoracleQueryAllMintRequestResponse {
  MintRequest?: SixprotocolnftoracleMintRequest[];
...
export interface NftoracleQueryAllSyncActionSignerResponse {
  SyncActionSigner?: SixprotocolnftoracleSyncActionSigner[];
...
export interface NftoracleQueryGetBindedSignerResponse {
  bindedSigner?: SixprotocolnftoracleBindedSigner;
}
...
export interface NftoracleQueryGetOracleConfigResponse {
  OracleConfig?: SixprotocolnftoracleOracleConfig;
}
...
export interface NftoracleQueryParamsResponse {
  ...
  params?: SixprotocolnftoracleParams;
}

export enum NftoracleRequestStatus {
  PENDING = "PENDING",
  SUCCESS_WITH_CONSENSUS = "SUCCESS_WITH_CONSENSUS",
  FAILED_WITHOUT_CONSENSUS = "FAILED_WITHOUT_CONSENSUS",
  EXPIRED = "EXPIRED",
...
export interface SixprotocolnftoracleActionOracleRequest {
  /** @format uint64 */
  id?: string;
...
export interface SixprotocolnftoracleActionSigner {
  actor_address?: string;
  owner_address?: string;
...
export interface SixprotocolnftoracleActionSignerConfig {
  chain?: string;
  contractAddress?: string;
  creator?: string;
}

export interface SixprotocolnftoracleBindedSigner {
  ownerAddress?: string;
...
export interface SixprotocolnftoracleCollectionOwnerRequest {
  /** @format uint64 */
  id?: string;
  nftSchemaCode?: string;
  signer?: string;
...
export interface SixprotocolnftoracleMintRequest {
  /** @format uint64 */
  id?: string;
  nft_schema_code?: string;
  token_id?: string;
...
export interface SixprotocolnftoracleOracleConfig {
  /** @format int32 */
 ...
 */
export interface SixprotocolnftoracleParams {
...
export interface SixprotocolnftoracleSyncActionSigner {
  /** @format uint64 */
  id?: string;
  chain?: string;
  actor_address?: string;
