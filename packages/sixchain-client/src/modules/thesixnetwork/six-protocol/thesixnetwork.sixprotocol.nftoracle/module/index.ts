...
const txClient = async (
  ...
  return {
    ...
    msgDeleteActionSignerConfig: (
      data: MsgDeleteActionSignerConfig
    ): EncodeObject => ({
      typeUrl:
        "/thesixnetwork.sixprotocol.nftoracle.MsgDeleteActionSignerConfig",
      value: MsgDeleteActionSignerConfig.fromPartial(data),
    }),
    msgDeleteActionSigner: (data: MsgDeleteActionSigner): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgDeleteActionSigner",
      value: MsgDeleteActionSigner.fromPartial(data),
    }),
    msgUpdateActionSigner: (data: MsgUpdateActionSigner): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgUpdateActionSigner",
      value: MsgUpdateActionSigner.fromPartial(data),
    }),
    msgSetMinimumConfirmation: (
      data: MsgSetMinimumConfirmation
    ): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgSetMinimumConfirmation",
      value: MsgSetMinimumConfirmation.fromPartial(data),
    }),
    msgCreateActionSignerConfig: (
      data: MsgCreateActionSignerConfig
    ): EncodeObject => ({
      typeUrl:
        "/thesixnetwork.sixprotocol.nftoracle.MsgCreateActionSignerConfig",
      value: MsgCreateActionSignerConfig.fromPartial(data),
    }),
    msgSubmitActionResponse: (data: MsgSubmitActionResponse): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgSubmitActionResponse",
      value: MsgSubmitActionResponse.fromPartial(data),
    }),
    msgSubmitSyncActionSigner: (
      data: MsgSubmitSyncActionSigner
    ): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgSubmitSyncActionSigner",
      value: MsgSubmitSyncActionSigner.fromPartial(data),
    }),
    msgCreateMintRequest: (data: MsgCreateMintRequest): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgCreateMintRequest",
      value: MsgCreateMintRequest.fromPartial(data),
    }),
    msgCreateVerifyCollectionOwnerRequest: (
      data: MsgCreateVerifyCollectionOwnerRequest
    ): EncodeObject => ({
      typeUrl:
        "/thesixnetwork.sixprotocol.nftoracle.MsgCreateVerifyCollectionOwnerRequest",
      value: MsgCreateVerifyCollectionOwnerRequest.fromPartial(data),
    }),
    msgSubmitMintResponse: (data: MsgSubmitMintResponse): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgSubmitMintResponse",
      value: MsgSubmitMintResponse.fromPartial(data),
    }),
    msgCreateActionSigner: (data: MsgCreateActionSigner): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgCreateActionSigner",
      value: MsgCreateActionSigner.fromPartial(data),
    }),
    msgCreateSyncActionSigner: (
      data: MsgCreateSyncActionSigner
    ): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgCreateSyncActionSigner",
      value: MsgCreateSyncActionSigner.fromPartial(data),
    }),
    msgCreateActionRequest: (data: MsgCreateActionRequest): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftoracle.MsgCreateActionRequest",
      value: MsgCreateActionRequest.fromPartial(data),
    }),
    msgUpdateActionSignerConfig: (
      data: MsgUpdateActionSignerConfig
    ): EncodeObject => ({
      typeUrl:
        "/thesixnetwork.sixprotocol.nftoracle.MsgUpdateActionSignerConfig",
      value: MsgUpdateActionSignerConfig.fromPartial(data),
    }),
    msgSubmitVerifyCollectionOwner: (
      data: MsgSubmitVerifyCollectionOwner
    ): EncodeObject => ({
      typeUrl:
        "/thesixnetwork.sixprotocol.nftoracle.MsgSubmitVerifyCollectionOwner",
      value: MsgSubmitVerifyCollectionOwner.fromPartial(data),
    }),
  };
};
