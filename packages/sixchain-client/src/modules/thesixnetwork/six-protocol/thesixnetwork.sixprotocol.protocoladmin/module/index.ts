...
const txClient = async (
  ...
  return {
    ...
    msgAddAdminToGroup: (data: MsgAddAdminToGroup): EncodeObject => ({
      ...
      value: MsgAddAdminToGroup.fromPartial(data),
    }),
    msgRemoveAdminFromGroup: (data: MsgRemoveAdminFromGroup): EncodeObject => ({
      typeUrl:
        "/thesixnetwork.sixprotocol.protocoladmin.MsgRemoveAdminFromGroup",
      value: MsgRemoveAdminFromGroup.fromPartial(data),
    }),
  };
};
