...
const txClient = async (
  ...
  return {
    ...
    msgCreateToken: (data: MsgCreateToken): EncodeObject => ({
      ...
      value: MsgCreateToken.fromPartial(data),
    }),
