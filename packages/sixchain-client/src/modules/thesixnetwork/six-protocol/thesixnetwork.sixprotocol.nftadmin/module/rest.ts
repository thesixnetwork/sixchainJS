...
export interface NftadminAddressList {
  addresses?: string[];
}
...
export interface NftadminQueryGetAuthorizationResponse {
  Authorization?: SixprotocolnftadminAuthorization;
}
...
export interface NftadminQueryParamsResponse {
  ...
  params?: SixprotocolnftadminParams;
}
...
export interface SixprotocolnftadminAuthorization {
  root_admin?: string;
 ...
 */
export type SixprotocolnftadminParams = object;
...
/**
 * @title nftadmin/authorization.proto
