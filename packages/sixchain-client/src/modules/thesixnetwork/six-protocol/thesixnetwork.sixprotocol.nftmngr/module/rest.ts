...
export interface NftmngrQueryAllActionByRefIdResponse {
  actionByRefId?: SixprotocolnftmngrActionByRefId[];
...
export interface NftmngrQueryAllActionExecutorResponse {
  actionExecutor?: SixprotocolnftmngrActionExecutor[];
...
export interface NftmngrQueryAllMetadataCreatorResponse {
  metadataCreator?: SixprotocolnftmngrMetadataCreator[];
...
export interface NftmngrQueryAllNFTSchemaByContractResponse {
  nFTSchemaByContract?: SixprotocolnftmngrNFTSchemaByContract[];
...
export interface NftmngrQueryAllNftDataResponse {
  nftData?: SixprotocolnftmngrNftData[];
...
export interface NftmngrQueryAllOrganizationResponse {
  organization?: SixprotocolnftmngrOrganization[];
...
export interface NftmngrQueryAllSchemaAttributeResponse {
  schemaAttribute?: SixprotocolnftmngrSchemaAttribute[];
...
export interface NftmngrQueryAllVirtualActionResponse {
...
export interface NftmngrQueryAllVirtualSchemaProposalResponse {
...
export interface NftmngrQueryAllVirtualSchemaResponse {
...
export interface NftmngrQueryGetNFTFeeBalanceResponse {
  NFTFeeBalance?: SixprotocolnftmngrNFTFeeBalance;
}

export interface NftmngrQueryGetNFTFeeConfigResponse {
  NFTFeeConfig?: SixprotocolnftmngrNFTFeeConfig;
}
...
export interface NftmngrQueryGetNftCollectionResponse {
  nftCollection?: SixprotocolnftmngrNftData[];
...
export interface NftmngrQueryGetVirtualActionResponse {
  virtualAction?: SixprotocolnftmngrVirtualAction;
}

export interface NftmngrQueryGetVirtualSchemaProposalResponse {
  virtualSchemaProposal?: SixprotocolnftmngrVirtualSchemaProposal;
}
...
export interface NftmngrQueryParamsResponse {
  ...
  params?: SixprotocolnftmngrParams;
}

export enum NftmngrRegistryStatus {
  PENDING = "PENDING",
  REJECT = "REJECT",
  ACCEPT = "ACCEPT",
}
...
export interface NftmngrTokenIdMap {
  nftSchemaName?: string;
  tokenId?: string;
}
...
export interface SixprotocolnftmngrActionByRefId {
  refId?: string;
  creator?: string;
  nftSchemaCode?: string;
  tokenId?: string;
...
export interface SixprotocolnftmngrActionExecutor {
  nftSchemaCode?: string;
  executorAddress?: string;
  creator?: string;
}

export interface SixprotocolnftmngrActionOfSchema {
  nftSchemaCode?: string;
  name?: string;
...
export interface SixprotocolnftmngrNFTFeeBalance {
  fee_balances?: string[];
}
...
export interface SixprotocolnftmngrNftData {
  nft_schema_code?: string;
  token_id?: string;
  token_owner?: string;
...
export interface SixprotocolnftmngrOrganization {
  name?: string;
  owner?: string;
}
 ...
 */
export type SixprotocolnftmngrParams = object;

export interface SixprotocolnftmngrSchemaAttribute {
  nftSchemaCode?: string;
  name?: string;
  data_type?: string;
...
export interface SixprotocolnftmngrVirtualSchema {
  virtualNftSchemaCode?: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryVirtualActionAll
   * @summary Queries a list of Virtual items.
   * @request GET:/thesixnetwork/sixnft/nftmngr/virtual_action
   */
   ...
   *
   * @tags Query
   * @name QueryVirtualSchemaAll
   * @summary Queries a list of VirtualSchema items.
   * @request GET:/thesixnetwork/sixnft/nftmngr/virtual_schema
   */
  queryVirtualSchemaAll = (
    query?: {
      "pagination.key"?: string;
      "pagination.offset"?: string;
      "pagination.limit"?: string;
   ...
   *
   * @tags Query
   * @name QueryVirtualSchema
   * @summary Queries a VirtualSchema by index.
   * @request GET:/thesixnetwork/sixnft/nftmngr/virtual_schema/{nftSchemaCode}
   */
  queryVirtualSchema = (nftSchemaCode: string, params: RequestParams = {}) =>
    this.request<NftmngrQueryGetVirtualSchemaResponse, RpcStatus>({
      path: `/thesixnetwork/sixnft/nftmngr/virtual_schema/${nftSchemaCode}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   *
   * @tags Query
   * @name QueryVirtualSchemaProposalAll
   * @summary Queries a list of VirtualSchemaProposal items.
   * @request GET:/thesixnetwork/sixnft/nftmngr/virtual_schema_proposal
   */
  queryVirtualSchemaProposalAll = (
    query?: {
      "pagination.key"?: string;
      "pagination.offset"?: string;
      "pagination.limit"?: string;
   ...
   *
   * @tags Query
   * @name QueryVirtualSchemaProposal
   * @summary Queries a VirtualSchemaProposal by index.
   * @request GET:/thesixnetwork/sixnft/nftmngr/virtual_schema_proposal/{index}
   */
  queryVirtualSchemaProposal = (index: string, params: RequestParams = {}) =>
    this.request<NftmngrQueryGetVirtualSchemaProposalResponse, RpcStatus>({
      path: `/thesixnetwork/sixnft/nftmngr/virtual_schema_proposal/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
