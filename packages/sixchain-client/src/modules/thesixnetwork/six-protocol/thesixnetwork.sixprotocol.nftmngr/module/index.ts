...
const types = [
  ...
  [
    "/thesixnetwork.sixprotocol.nftmngr.MsgUpdateActionExecutor",
...
const txClient = async (
  ...
  return {
    ...
    msgResyncAttributes: (data: MsgResyncAttributes): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgResyncAttributes",
      value: MsgResyncAttributes.fromPartial(data),
    }),
    msgSetMetadataFormat: (data: MsgSetMetadataFormat): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetMetadataFormat",
      value: MsgSetMetadataFormat.fromPartial(data),
    }),
    msgPerformVirtualAction: (data: MsgPerformVirtualAction): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgPerformVirtualAction",
      value: MsgPerformVirtualAction.fromPartial(data),
    }),
    msgSetAttributeOveriding: (
      data: MsgSetAttributeOveriding
    ): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetAttributeOveriding",
      value: MsgSetAttributeOveriding.fromPartial(data),
    }),
    msgUpdateActionExecutor: (data: MsgUpdateActionExecutor): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgUpdateActionExecutor",
      value: MsgUpdateActionExecutor.fromPartial(data),
    }),
    msgAddAction: (data: MsgAddAction): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgAddAction",
      value: MsgAddAction.fromPartial(data),
    }),
    msgShowAttributes: (data: MsgShowAttributes): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgShowAttributes",
      value: MsgShowAttributes.fromPartial(data),
    }),
    msgPerformActionByAdmin: (data: MsgPerformActionByAdmin): EncodeObject => ({
      ...
      value: MsgPerformActionByAdmin.fromPartial(data),
    }),
    msgChangeSchemaOwner: (data: MsgChangeSchemaOwner): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgChangeSchemaOwner",
      value: MsgChangeSchemaOwner.fromPartial(data),
    }),
    msgChangeOrgOwner: (data: MsgChangeOrgOwner): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgChangeOrgOwner",
      value: MsgChangeOrgOwner.fromPartial(data),
    }),
    msgSetFeeConfig: (data: MsgSetFeeConfig): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetFeeConfig",
      value: MsgSetFeeConfig.fromPartial(data),
    }),
    msgSetOriginChain: (data: MsgSetOriginChain): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetOriginChain",
      value: MsgSetOriginChain.fromPartial(data),
    }),
    msgCreateActionExecutor: (data: MsgCreateActionExecutor): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgCreateActionExecutor",
      value: MsgCreateActionExecutor.fromPartial(data),
    }),
    msgSetBaseUri: (data: MsgSetBaseUri): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetBaseUri",
      value: MsgSetBaseUri.fromPartial(data),
    }),
    msgSetMintauth: (data: MsgSetMintauth): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetMintauth",
      value: MsgSetMintauth.fromPartial(data),
    }),
    msgSetOriginContract: (data: MsgSetOriginContract): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetOriginContract",
      value: MsgSetOriginContract.fromPartial(data),
    }),
    msgDeleteActionExecutor: (data: MsgDeleteActionExecutor): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgDeleteActionExecutor",
      value: MsgDeleteActionExecutor.fromPartial(data),
    }),
    msgAddAttribute: (data: MsgAddAttribute): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgAddAttribute",
      value: MsgAddAttribute.fromPartial(data),
    }),
    msgUpdateSchemaAttribute: (
      data: MsgUpdateSchemaAttribute
    ): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgUpdateSchemaAttribute",
      value: MsgUpdateSchemaAttribute.fromPartial(data),
    }),
    msgCreateMetadata: (data: MsgCreateMetadata): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgCreateMetadata",
      value: MsgCreateMetadata.fromPartial(data),
    }),
    msgVoteVirtualSchemaProposal: (
      data: MsgVoteVirtualSchemaProposal
    ): EncodeObject => ({
      typeUrl:
        "/thesixnetwork.sixprotocol.nftmngr.MsgVoteVirtualSchemaProposal",
      value: MsgVoteVirtualSchemaProposal.fromPartial(data),
    }),
    msgDeleteVirtualAction: (data: MsgDeleteVirtualAction): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgDeleteVirtualAction",
      value: MsgDeleteVirtualAction.fromPartial(data),
    }),
    msgCreateNFTSchema: (data: MsgCreateNFTSchema): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgCreateNFTSchema",
      value: MsgCreateNFTSchema.fromPartial(data),
    }),
    msgToggleAction: (data: MsgToggleAction): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgToggleAction",
      value: MsgToggleAction.fromPartial(data),
    }),
    msgUpdateAction: (data: MsgUpdateAction): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgUpdateAction",
      value: MsgUpdateAction.fromPartial(data),
    }),
    msgProposalVirtualSchema: (
      data: MsgProposalVirtualSchema
    ): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgProposalVirtualSchema",
      value: MsgProposalVirtualSchema.fromPartial(data),
    }),
    msgCreateVirtualAction: (data: MsgCreateVirtualAction): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgCreateVirtualAction",
      value: MsgCreateVirtualAction.fromPartial(data),
    }),
    msgUpdateVirtualAction: (data: MsgUpdateVirtualAction): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgUpdateVirtualAction",
      value: MsgUpdateVirtualAction.fromPartial(data),
    }),
    msgSetUriRetrievalMethod: (
      data: MsgSetUriRetrievalMethod
    ): EncodeObject => ({
      typeUrl: "/thesixnetwork.sixprotocol.nftmngr.MsgSetUriRetrievalMethod",
      value: MsgSetUriRetrievalMethod.fromPartial(data),
    }),
  };
};
