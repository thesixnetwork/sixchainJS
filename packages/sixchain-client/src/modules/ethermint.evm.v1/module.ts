...
import { AccessControl as typeAccessControl} from "./types"
import { AccessControlType as typeAccessControlType} from "./types"
...
import { OverrideAccount as typeOverrideAccount} from "./types"
import { StateOverride as typeStateOverride} from "./types"
import { BlockOverrides as typeBlockOverrides} from "./types"
import { TraceCallConfig as typeTraceCallConfig} from "./types"
...
export { MsgEthereumTx, MsgUpdateParams };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgUpdateParams({ value }: msgUpdateParamsParams): EncodeObject {
			try {
				return { typeUrl: "/ethermint.evm.v1.MsgUpdateParams", value: MsgUpdateParams.fromPartial( value ) }  
			} catch (e: any) {
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						AccessControl: getStructure(typeAccessControl.fromPartial({})),
						AccessControlType: getStructure(typeAccessControlType.fromPartial({})),
						...
						OverrideAccount: getStructure(typeOverrideAccount.fromPartial({})),
						StateOverride: getStructure(typeStateOverride.fromPartial({})),
						BlockOverrides: getStructure(typeBlockOverrides.fromPartial({})),
						TraceCallConfig: getStructure(typeTraceCallConfig.fromPartial({})),
...
const IgntModule = (test: IgniteClient) => {
	return {
		module: {
			EthermintEvmV_1: new SDKModule(test)
		},
		registry: msgTypes
  }
}
