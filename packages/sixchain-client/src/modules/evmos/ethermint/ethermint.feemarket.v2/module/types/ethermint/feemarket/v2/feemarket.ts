...
export const protobufPackage = "ethermint.feemarket.v2";
...
export const Params = {
  encode(message: Params, writer: Writer = Writer.create()): Writer {
    ...
    if (message.legacy_base_fee !== "") {
      writer.uint32(74).string(message.legacy_base_fee);
    }
    if (message.legacy_min_gas_price !== "") {
      writer.uint32(82).string(message.legacy_min_gas_price);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          break;
        case 9:
          message.legacy_base_fee = reader.string();
          break;
        case 10:
          message.legacy_min_gas_price = reader.string();
          break;
        default:
  ...
  fromJSON(object: any): Params {
    ...
    if (
      object.legacy_base_fee !== undefined &&
      object.legacy_base_fee !== null
    ) {
      message.legacy_base_fee = String(object.legacy_base_fee);
    } else {
      message.legacy_base_fee = "";
    }
    if (
      object.legacy_min_gas_price !== undefined &&
      object.legacy_min_gas_price !== null
    ) {
      message.legacy_min_gas_price = String(object.legacy_min_gas_price);
    } else {
      message.legacy_min_gas_price = "";
    }
    return message;
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.legacy_base_fee !== undefined &&
      (obj.legacy_base_fee = message.legacy_base_fee);
    message.legacy_min_gas_price !== undefined &&
      (obj.legacy_min_gas_price = message.legacy_min_gas_price);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    if (
      ...
      message.legacy_base_fee = object.legacy_base_fee;
    } else {
      message.legacy_base_fee = "";
    }
    if (
      ...
      message.legacy_min_gas_price = object.legacy_min_gas_price;
    } else {
      message.legacy_min_gas_price = "";
    }
    return message;
