...
export interface Feemarketv2Params {
  no_base_fee?: boolean;
 ...
 */
export interface V2QueryBaseFeeResponse {
  base_fee?: string;
}
 ...
 */
export interface V2QueryBlockGasResponse {
  /** @format int64 */
  gas?: string;
}
...
/**
 * @title ethermint/feemarket/v2/feemarket.proto
...
> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/ethermint/feemarket/v2/base_fee
   */
  queryBaseFee = (params: RequestParams = {}) =>
    this.request<V2QueryBaseFeeResponse, RpcStatus>({
      path: `/ethermint/feemarket/v2/base_fee`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/ethermint/feemarket/v2/block_gas
   */
  queryBlockGas = (params: RequestParams = {}) =>
    this.request<V2QueryBlockGasResponse, RpcStatus>({
      path: `/ethermint/feemarket/v2/block_gas`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/ethermint/feemarket/v2/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V2QueryParamsResponse, RpcStatus>({
      path: `/ethermint/feemarket/v2/params`,
      method: "GET",
      format: "json",
      ...params,
    });
