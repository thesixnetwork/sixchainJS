...
import { ValidatorApproval as typeValidatorApproval} from "./types"
import { WhitelistDelegator as typeWhitelistDelegator} from "./types"

export { MsgSetValidatorApproval, MsgCreateValidator, MsgEditValidator, MsgDelegate, MsgBeginRedelegate, MsgUndelegate, MsgCancelUnbondingDelegation, MsgUpdateParams, MsgCreateWhitelistDelegator, MsgDeleteWhitelistDelegator };

type sendMsgSetValidatorApprovalParams = {
  value: MsgSetValidatorApproval,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgCreateWhitelistDelegatorParams = {
  value: MsgCreateWhitelistDelegator,
  fee?: StdFee,
  memo?: string
};

type sendMsgDeleteWhitelistDelegatorParams = {
  value: MsgDeleteWhitelistDelegator,
  fee?: StdFee,
  memo?: string
};


type msgSetValidatorApprovalParams = {
  value: MsgSetValidatorApproval,
};
...
type msgCreateWhitelistDelegatorParams = {
  value: MsgCreateWhitelistDelegator,
};

type msgDeleteWhitelistDelegatorParams = {
  value: MsgDeleteWhitelistDelegator,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendMsgSetValidatorApproval({ value, fee, memo }: sendMsgSetValidatorApprovalParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgSetValidatorApproval: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgSetValidatorApproval({ value: MsgSetValidatorApproval.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgSetValidatorApproval: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgCreateWhitelistDelegator({ value, fee, memo }: sendMsgCreateWhitelistDelegatorParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgCreateWhitelistDelegator: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgCreateWhitelistDelegator({ value: MsgCreateWhitelistDelegator.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgCreateWhitelistDelegator: Could not broadcast Tx: '+ e.message)
			}
		},
		
		async sendMsgDeleteWhitelistDelegator({ value, fee, memo }: sendMsgDeleteWhitelistDelegatorParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgDeleteWhitelistDelegator: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgDeleteWhitelistDelegator({ value: MsgDeleteWhitelistDelegator.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgDeleteWhitelistDelegator: Could not broadcast Tx: '+ e.message)
			}
		},
		
		
		msgSetValidatorApproval({ value }: msgSetValidatorApprovalParams): EncodeObject {
			try {
				return { typeUrl: "/cosmos.staking.v1beta1.MsgSetValidatorApproval", value: MsgSetValidatorApproval.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgSetValidatorApproval: Could not create message: ' + e.message)
			}
		},
		...
		msgCreateWhitelistDelegator({ value }: msgCreateWhitelistDelegatorParams): EncodeObject {
			try {
				return { typeUrl: "/cosmos.staking.v1beta1.MsgCreateWhitelistDelegator", value: MsgCreateWhitelistDelegator.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgCreateWhitelistDelegator: Could not create message: ' + e.message)
			}
		},
		
		msgDeleteWhitelistDelegator({ value }: msgDeleteWhitelistDelegatorParams): EncodeObject {
			try {
				return { typeUrl: "/cosmos.staking.v1beta1.MsgDeleteWhitelistDelegator", value: MsgDeleteWhitelistDelegator.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgDeleteWhitelistDelegator: Could not create message: ' + e.message)
			}
		},
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						ValidatorApproval: getStructure(typeValidatorApproval.fromPartial({})),
						WhitelistDelegator: getStructure(typeWhitelistDelegator.fromPartial({})),
