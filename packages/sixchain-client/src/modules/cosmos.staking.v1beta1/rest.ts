...
import { QueryValidatorApprovalResponse } from "./types/cosmos/staking/v1beta1/query";
...
import { QueryWhitelistdelegatorResponse } from "./types/cosmos/staking/v1beta1/query";
import { QueryWhitelistdelegatorAllResponse } from "./types/cosmos/staking/v1beta1/query";

import { QueryValidatorApprovalRequest } from "./types/cosmos/staking/v1beta1/query";
...
import { QueryGetWhitelistDelegatorRequest } from "./types/cosmos/staking/v1beta1/query";
import { QueryAllWhitelistDelegatorRequest } from "./types/cosmos/staking/v1beta1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  /**
   * QueryValidatorApproval
   *
   * @tags Query
   * @name queryValidatorApproval
   * @request GET:/cosmos/staking/v1beta1/validator_approval
   */
  queryValidatorApproval = (
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryValidatorApprovalResponse>>>({
      path: `/cosmos/staking/v1beta1/validator_approval`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  /**
   * QueryWhitelistdelegator
   *
   * @tags Query
   * @name queryWhitelistdelegator
   * @request GET:/cosmos/staking/v1beta1/whitelistdelegator/{validator}
   */
  queryWhitelistdelegator = (validator: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryWhitelistdelegatorResponse>>>({
   ...
   */
  queryWhitelistdelegatorAll = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllWhitelistDelegatorRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryWhitelistdelegatorAllResponse>>>({
