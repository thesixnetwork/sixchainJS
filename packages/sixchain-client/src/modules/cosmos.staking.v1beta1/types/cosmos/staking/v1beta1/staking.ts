...
export const Validator: MessageFns<Validator> = {
  ...
  fromJSON(object: any): Validator {
    return {
      ...
      licenseCount: isSet(object.licenseCount) ? globalThis.String(object.licenseCount) : "",
  ...
  toJSON(message: Validator): unknown {
    ...
    if (message.licenseCount !== "") {
      obj.licenseCount = message.licenseCount;
    }
    if (message.licenseMode !== false) {
...
function createBaseValidatorApproval(): ValidatorApproval {
  return { approverAddress: "", enabled: false };
}

export const ValidatorApproval: MessageFns<ValidatorApproval> = {
  encode(message: ValidatorApproval, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidatorApproval {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<ValidatorApproval>, I>>(base?: I): ValidatorApproval {
    return ValidatorApproval.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatorApproval>, I>>(object: I): ValidatorApproval {
    const message = createBaseValidatorApproval();
