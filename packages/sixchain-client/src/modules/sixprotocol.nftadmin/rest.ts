...
import { QueryGetAuthorizationResponse } from "./types/sixprotocol/nftadmin/query";

import { QueryParamsRequest } from "./types/sixprotocol/nftadmin/query";
import { QueryGetAuthorizationRequest } from "./types/sixprotocol/nftadmin/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/thesixnetwork/six-protocol/nftadmin/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/thesixnetwork/six-protocol/nftadmin/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryAuthorization = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetAuthorizationResponse>>>({
