...
//   protoc               unknown
// source: sixprotocol/protocoladmin/genesis.proto
...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, adminList: [], groupList: [] };
}
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.adminList) {
      Admin.encode(v!, writer.uint32(18).fork()).join();
    }
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      adminList: globalThis.Array.isArray(object?.adminList) ? object.adminList.map((e: any) => Admin.fromJSON(e)) : [],
      groupList: globalThis.Array.isArray(object?.groupList) ? object.groupList.map((e: any) => Group.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.adminList?.length) {
      obj.adminList = message.adminList.map((e) => Admin.toJSON(e));
    }
    if (message.groupList?.length) {
      obj.groupList = message.groupList.map((e) => Group.toJSON(e));
    }
    return obj;
  },
