...
import { QueryParamsResponse } from "./types/ethermint/feemarket/v1/query";
import { QueryBaseFeeResponse } from "./types/ethermint/feemarket/v1/query";
import { QueryBlockGasResponse } from "./types/ethermint/feemarket/v1/query";

import { QueryParamsRequest } from "./types/ethermint/feemarket/v1/query";
import { QueryBaseFeeRequest } from "./types/ethermint/feemarket/v1/query";
import { QueryBlockGasRequest } from "./types/ethermint/feemarket/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryBlockGas = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryBlockGasResponse>>>({
